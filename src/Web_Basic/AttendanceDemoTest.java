...
public class AttendanceDemoTest {
  ...
  @Test
  public void attendanceDemo() {
    driver.get("https://docs.google.com/forms/d/e/1FAIpQLSfThrnk9ArdDEZsehL-Njz8Gf_R4_MC_6AOEx6BFqY59grKnA/viewform");
    driver.findElement(By.cssSelector(".quantumWizTextinputPaperinputEl:nth-child(2) .quantumWizTextinputPaperinputInput")).click();
//    driver.findElement(By.cssSelector(".quantumWizTextinputPaperinputEl:nth-child(2) .quantumWizTextinputPaperinputInput")).sendKeys("0002-07-19");
//    driver.findElement(By.cssSelector(".quantumWizTextinputPaperinputEl:nth-child(2) .quantumWizTextinputPaperinputInput")).sendKeys("0020-07-19");
//    driver.findElement(By.cssSelector(".quantumWizTextinputPaperinputEl:nth-child(2) .quantumWizTextinputPaperinputInput")).sendKeys("0202-07-19");
    driver.findElement(By.cssSelector(".quantumWizTextinputPaperinputEl:nth-child(2) .quantumWizTextinputPaperinputInput")).sendKeys("2021-07-19");
